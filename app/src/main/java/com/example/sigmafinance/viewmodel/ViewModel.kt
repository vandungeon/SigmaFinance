...
class ViewModel @Inject constructor(
    ...
    private val _FundsEvents = MediatorLiveData<List<DBType.FundsEvent>>()
        val FundsEvent: LiveData<List<DBType.FundsEvent>> = _FundsEvents
    private val _FundsEventsRecurring = MediatorLiveData<List<DBType.FundsEventRecurring>>()
        val FundsEventRecurring: LiveData<List<DBType.FundsEventRecurring>> = _FundsEventsRecurring
    ...
    private fun checkInitialization() {
        if (_FundsEvents.value != null && _FundsEventsRecurring.value != null && _DaysWithEvents != null) {
